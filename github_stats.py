...
class Stats(object):
    ...
    def __init__(self, username: str, access_token: str,
                 ...
                 exclude_repos: Optional[Set] = None,  exclude_languages=['WebAssembly']):
        self.username = username
  ...
  - {formatted_languages}"""
    ...
    async def get_stats(self) -> None:
        ...
        while True:
            ...
            for repo in repos:
                ...
                for lang in repo.get("languages", {}).get("edges", []):
                    ...
                    # TODO, add here custom rules, for autogenerated and testing
                    # type files, for example, the 98% of my stats (Jacarte) are
                    # for Wasm, but most of them are just due to my current research
                    if name not in self.exclude_languages:
        ...
        for k, v in self._languages.items():
            ...
            v["count"] = 100 * (v.get("occurrences", 0) / langs_total_count)
